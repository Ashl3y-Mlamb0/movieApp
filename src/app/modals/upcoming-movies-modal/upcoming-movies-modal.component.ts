...
@Component({
  selector: 'app-upcoming-movies-modal',
  templateUrl: './upcoming-movies-modal.component.html',
  styleUrls: ['./upcoming-movies-modal.component.scss'],
  standalone: true,
...
export class UpcomingMoviesModalComponent  implements OnInit {
  UpcomingMovies: any[] = [];
  currentPage = 1;
