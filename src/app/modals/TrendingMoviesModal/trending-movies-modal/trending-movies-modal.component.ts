...
@Component({
  selector: 'app-trending-movies-modal',
  templateUrl: './trending-movies-modal.component.html',
  styleUrls: ['./trending-movies-modal.component.scss'],
  standalone: true,
...
export class TrendingMoviesModalComponent implements OnInit {
  trendingMovies: any[] = [];
  currentPage = 1;
